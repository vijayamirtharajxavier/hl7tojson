...
public class HL7toJsonSubFieldName {
    ...
    private static Map<String, Object> getFieldNames(Segment segment) {
        Map<String, Object> fieldNames = new TreeMap<>(Comparator.comparingInt(HL7toJsonSubFieldName::extractNumberFromKey));
    ...
    private static Map<String, Object> getSubFields(Composite composite) {
        Map<String, Object> subFieldNames = new TreeMap<>(Comparator.comparingInt(HL7toJsonSubFieldName::extractNumberFromKey));
        ...
        for (String segmentName : message.getNames()) {
            try {
                ...
                for (Structure segment : segments) {
                    Map<String, Object> fieldNames = getFieldNames((Segment) segment);
